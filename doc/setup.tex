...
and Windows (2k, XP and also less reliably on 95/98/Me).
 ...
 If you use Linux then presumably you already have Perl and cvs installed and
you can go directly to Section~\ref{sec-ocaml}.
...
\item Add \t{C:\\Programs\\cygwin\\bin} to your PATH. You must put it first in
the ``System Variables'' PATH (In Control Panel/System/Advanced/Environment
Variables''. Essentially this must come before the default c:/WinNT/system32.
You can verify that you got it right if you get \t{/usr/bin/find} when you run
\t{which find}. 
\end{itemize}
