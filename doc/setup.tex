...
At the time of writing, the current version is 3.06 (but all of our tools
should work with 3.04 and 3.05 as well). The following instructions assume
that you will build from sources even on Windows (instead of using the Native
compiler provided). Here the rough sequence of steps:
\begin{itemize}
