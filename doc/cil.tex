...
of a variable or function must appear before its use in a file. 
 ...
 CIL supports pragmas only at the top level. 
...
precision, floating point types, enumeration types, array and pointer type,
and function types. 
...
All uses of type names (through the TNamed constructor) must be preceeded by
a GType global that defines the name. If you want to 
