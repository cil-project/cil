...
since Linux contains many of the ugly GCC extensions (see \secref{ugly-ugly}).
...
\item \t{--aggressive-merge}. We try to merge all isomorphic type names
independent of their original names. 
