...
$TEST->addTests("test/attr9", "_GNUCC=1 WARNINGS_ARE_ERRORS=1", ['cil'], Enabled=>0);
...
$TEST->addTests("testrun/init18", "", ['cil'], Enabled=>0);
...
$TEST->addTests("runall/nullterm", "", ['inferbox'], Enabled=>0);
$TEST->addTests("scott/nullterm2", "", ['inferbox']);
$TEST->addTests("scott/nullterm3", "", ['inferbox']);
$TEST->addTests("runall/sentinel", "", ['inferbox'], Enabled=>0);
